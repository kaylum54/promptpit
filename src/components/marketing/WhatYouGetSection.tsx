export function WhatYouGetSection() {
  const features = [
    {
      title: 'Complete PRD',
      description: 'Features, user stories, acceptance criteria — everything documented.',
      icon: (
    ...
    },
    {
      ...
      description: 'Auth, validation, rate limiting, headers. Security covered.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Standard features every SaaS needs. Users, billing, moderation.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'One-shot buildable spec. Paste into Claude Code, watch it build.',
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-black mb-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group bg-gray-50 hover:bg-white rounded-xl p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-lg bg-white border border-gray-200 text-gray-600 flex items-center justify-center mb-4 group-hover:bg-black group-hover:text-white group-hover:border-black transition-all duration-300">
                {feature.icon}
              </div>
